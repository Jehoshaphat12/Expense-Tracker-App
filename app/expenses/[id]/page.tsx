...
export default function ExpenseDetail() {
  ...
  return (
    <div className="p-6 rounded-2xl bg-gray-100 max-w-xl mx-auto">
      <h2 className="text-2xl text-center font-semibold mb-4">
        Transaction Details
      </h2>
      <div className="space-y-1 py-4 pb-6 bg-white px-6 rounded-2xl">
      ...
      <button
        ...
        className="mt-3 w-full bg-white text-blue-600 font-semibold py-2 rounded-2xl hover:bg-blue-700 hover:text-white transition"
      >
        Edit Expense
      </button>
      {/* <button
