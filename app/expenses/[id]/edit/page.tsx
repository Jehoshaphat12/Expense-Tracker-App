...
export default function EditTransactionPage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 dark:text-gray-50 p-6 rounded-2xl shadow-lg max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input
          ...
          placeholder="Title"
          className="w-full py-3 px-4 focus:outline-2 outline-blue-600 bg-gray-200 dark:bg-gray-700 dark:text-gray-50 rounded-xl"
          required
        />
        <label htmlFor="amount" className="text-sm mb-3">
          Amount
