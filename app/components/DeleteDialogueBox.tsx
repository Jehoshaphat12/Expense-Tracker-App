  ...
  return (
    <>
      <button
        ...
        className="mt-3 w-full font-semibold bg-white text-red-600 py-2 rounded-2xl dark:border dark:border-gray-600 hover:bg-red-700 hover:text-white transition"
      >
        {" "}
        Delete Transaction
      </button>
