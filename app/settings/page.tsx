...
export default function SettingPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto p-4 space-y-6 pb-30 dark:bg-gray-800">
        ...
        >
          ...
          {darkMode ? "Dark" : "Light"}
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow">
                <h2 className="text-lg font-semibold mb-3 dark:text-gray-50">Profile Settings</h2>
                 <div className="space-y-3">
                    <input
                        type="text"
                        placeholder="Name"
                        className="w-full border dark:border-gray-600 rounded-lg px-3 py-2 dark:text-gray-50"
                    />
                    <input
                        type="email"
                        placeholder="Email"
          ...
          {/* Currency Preference */}
          <div className="bg-white dark:bg-gray-800  p-4 rounded-2xl shadow">
        <h2 className="text-lg font-semibold mb-3 dark:text-gray-50">Currency Preference</h2>
        <select
          value={currency}
          onChange={(e) => setCurrency(e.target.value)}
          className="w-full border dark:border-gray-600 dark:text-gray-50 rounded-lg px-3 py-2"
        >
          {currencies.map((curr) => (
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow flex items-center justify-between">
        <h2 className="text-lg font-semibold dark:text-gray-50">Notifications</h2>
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="dark:text-gray-50">{notifications ? "Enabled" : "Disabled"}</span>
        </label>
      </div>

       {/* Data Management */}
      <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow space-y-3">
        <h2 className="text-lg font-semibold mb-2 dark:text-gray-50">Data Management</h2>
